...
class CoreFinancePayableModal extends Model
{
  use HasFactory;
  ...
  /**
   * Get the user who approved the payable.
   */
  ...
  /**
   * Get the payments for the payable.
   */
  public function payments(): HasMany
  {
    return $this->hasMany(CoreFinancePayablePaymentModal::class, 'payable_id');
  }

  /**
   * Get the journal entries for the payable.
   */
  ...
  /**
   * Check if the payable is approved.
   */
  ...
  /**
   * Scope a query to only include overdue payables.
   */
  ...
  /**
   * Scope a query to only include payables due within days.
   */
  ...
  /**
   * Scope a query to only include unpaid payables.
   */
  ...
  /**
   * Scope a query to only include fully paid payables.
   */
  ...
  /**
   * Scope a query to only include payables with a specific status.
   */
  ...
  /**
   * Scope a query to only include approved payables.
   */
  ...
  /**
   * Scope a query to only include unapproved payables.
   */
