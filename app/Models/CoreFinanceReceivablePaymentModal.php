...
class CoreFinanceReceivablePaymentModal extends Model
{
  use HasFactory;

  protected $table = 'finance_receivable_payments';
  ...
  {
    return $this->belongsTo(CoreFinanceReceivableModal::class, 'receivable_id');
  }
