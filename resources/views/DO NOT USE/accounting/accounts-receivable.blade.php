                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center row">
                            <div class="col-sm-7">
                                <h4 class="card-title text-primary">Accounts Receivable</h4>
                                <p class="mb-0">Manage customer invoices and payments</p>
                            </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                data-bs-target="#recordPaymentModal"><i
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="card-info">
                                <p class="card-text">Total Receivables</p>
                                <div class="d-flex align-items-end mb-2">
                                    <h4 class="card-title mb-0 me-2">$75,000</h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="card-info">
                                ...
                                <div class="d-flex align-items-end mb-2">
                                    <h4 class="card-title mb-0 me-2">$10,000</h4>
                                    <small class="text-danger">(+20%)</small>
                                </div>
                                <small>8 invoices overdue</small>
                            </div>
                            <div class="card-icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="card-info">
                                <p class="card-text">Collected This Month</p>
                                <div class="d-flex align-items-end mb-2">
                                    <h4 class="card-title mb-0 me-2">$45,000</h4>
                                    <small class="text-success">(+15%)</small>
                                </div>
                                <small>25 payments received</small>
                            </div>
                            <div class="card-icon">
                            ...
                            <tbody>
                                @forelse($invoices ?? [] as $invoice)
                                    <tr>
                                        ...
                                        <td>{{ $invoice->customer->name ?? 'Customer Name' }}</td>
    ...
    <div class="modal fade" id="createInvoiceModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('accounting.accounts-receivable.store') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="recordPaymentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('accounting.accounts-receivable.payments.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-12">
