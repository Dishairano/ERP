                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($stream->budgets as $budget)
                                                    <tr>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><strong>{{ number_format($stream->budgets->sum('planned_amount'), 2) }}</strong>
                                                    </td>
                                                    <td><strong>{{ number_format($stream->budgets->sum('actual_amount'), 2) }}</strong>
                                                    </td>
                                                    <td colspan="2"></td>
                                                </tr>
                                            </tfoot>
