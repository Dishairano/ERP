...
@section('title', 'HRM - Create Training Program')

@section('content')
    <h4 class="fw-bold">Create Training Program</h4>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('hrm.training-development.store') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="trainer" id="trainer"
                            class="form-control @error('trainer') is-invalid @enderror" required>
                        @error('trainer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="max_participants" id="max_participants"
                            class="form-control @error('max_participants') is-invalid @enderror" min="1" required>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="prerequisites" id="prerequisites" rows="3"
                            class="form-control @error('prerequisites') is-invalid @enderror"></textarea>
                        @error('prerequisites')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="materials" id="materials" rows="3" class="form-control @error('materials') is-invalid @enderror"></textarea>
                        @error('materials')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
