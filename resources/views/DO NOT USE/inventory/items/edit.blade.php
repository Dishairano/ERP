                        ...
                        <form action="{{ route('inventory.items.update', $item) }}" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="unit_cost" step="0.01"
                                                min="0" value="{{ $item->unit_cost }}" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="status" required>
                                            ...
                                            <option value="discontinued"
                                                {{ $item->status === 'discontinued' ? 'selected' : '' }}>Discontinued
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox" name="is_stockable"
                                                id="isStockable" {{ $item->is_stockable ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox" name="is_purchasable"
                                                id="isPurchasable" {{ $item->is_purchasable ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_sellable"
                                                id="isSellable" {{ $item->is_sellable ? 'checked' : '' }}>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="dimensions"
                                                    value="{{ $item->dimensions }}" placeholder="e.g., 10 x 5 x 3 cm">
                                            </div>
                                            <div class="mb-3">
                                ...
                                <div class="col-12 stock-levels-section">
                                    <h6 class="mb-3 mt-3">Stock Levels</h6>
