            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Edit Project Template</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('projects.templates.update', $template) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="description" rows="3">{{ old('description', $template->description) }}</textarea>
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Default Phases</label>
                                    <div id="phases-container">
                                        @foreach (json_decode($template->default_phases ?? '[]', true) as $phase)
                                            <div class="phase-item mb-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="phases[]"
                                                        value="{{ $phase }}" placeholder="Phase name">
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="tasks-container">
                                        @foreach (json_decode($template->default_tasks ?? '[]', true) as $task)
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="milestones-container">
                                        @foreach (json_decode($template->default_milestones ?? '[]', true) as $milestone)
                                            <div class="milestone-item mb-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="milestones[]"
                                                        value="{{ $milestone }}" placeholder="Milestone name">
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="roles-container">
                                        @foreach (json_decode($template->default_team_structure ?? '[]', true) as $role)
                                            <div class="role-item mb-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="roles[]"
                                                        value="{{ $role }}" placeholder="Role name">
