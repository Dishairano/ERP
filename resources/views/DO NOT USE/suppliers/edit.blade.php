            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Leverancier Bewerken - {{ $supplier->name }}</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('classification') is-invalid @enderror"
                                            ...
                                            <option value="strategic"
                                                {{ old('classification', $supplier->classification) == 'strategic' ? 'selected' : '' }}>
                                                Strategisch
                                            </option>
                                            <option value="tactical"
                                                {{ old('classification', $supplier->classification) == 'tactical' ? 'selected' : '' }}>
                                                Tactisch
                                            </option>
                                            <option value="operational"
                                                {{ old('classification', $supplier->classification) == 'operational' ? 'selected' : '' }}>
                                                Operationeel
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="is_critical"
                                                ...
                                                {{ old('is_critical', $supplier->is_critical) ? 'checked' : '' }}>
