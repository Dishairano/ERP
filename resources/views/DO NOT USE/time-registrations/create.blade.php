            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Create Time Registration</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('time-registrations.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="time_category_id"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @selected(old('time_category_id') == $category->id)>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="break_duration_minutes"
                                        ...
                                        value="{{ old('break_duration_minutes', 0) }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mt-3">
                                        <input type="checkbox" name="is_billable"
                                            ...
                                            value="1" @checked(old('is_billable', true))>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ri-save-line"></i> Save Time Registration
                                    </button>
