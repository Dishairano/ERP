            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('time-registration.show', ['time_registration' => $registration]) }}" class="btn btn-secondary">
                            <i class="ri-arrow-left-line me-1"></i> Back to Details
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('time-registration.update', ['time_registration' => $registration]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-date @error('date') is-invalid @enderror"
                                        id="date" name="date"
                                        value="{{ old('date', $registration->date->format('Y-m-d')) }}"
                                        required>
                                    @error('date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-time @error('start_time') is-invalid @enderror"
                                        ...
                                        value="{{ old('start_time', \Carbon\Carbon::parse($registration->start_time)->format('H:i')) }}"
                                        required>
                                    @error('start_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-time @error('end_time') is-invalid @enderror"
                                        ...
                                        value="{{ old('end_time', \Carbon\Carbon::parse($registration->end_time)->format('H:i')) }}"
                                        required>
                                    @error('end_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="draft" {{ old('status', $registration->status) == 'draft' ? 'selected' : '' }}>
                                            Draft</option>
                                        <option value="submitted" {{ old('status', $registration->status) == 'submitted' ? 'selected' : '' }}>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('time-registration.show', ['time_registration' => $registration]) }}" class="btn btn-label-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
