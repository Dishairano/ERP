...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">Edit Assessment</h4>
            <div>
                <a href="{{ route('assessments.show', $assessment) }}" class="btn btn-primary me-2">
                    <i class="ri-eye-line"></i> View Assessment
                </a>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select @error('job_posting_id') is-invalid @enderror" id="job_posting_id"
                                ...
                                @foreach ($jobPostings as $posting)
                                    <option value="{{ $posting->id }}" @selected(old('job_posting_id', $assessment->job_posting_id) == $posting->id)>
                                        {{ $posting->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select @error('candidate_id') is-invalid @enderror" id="candidate_id"
                                ...
                                @foreach ($candidates as $candidate)
                                    <option value="{{ $candidate->id }}" @selected(old('candidate_id', $assessment->candidate_id) == $candidate->id)>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('assessment_type') is-invalid @enderror" id="assessment_type"
                                ...
                                @foreach ($assessmentTypes as $type)
                                    <option value="{{ $type }}" @selected(old('assessment_type', $assessment->assessment_type) == $type)>
                                        {{ ucfirst($type) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('assessor_id') is-invalid @enderror" id="assessor_id"
                                ...
                                @foreach ($assessors as $assessor)
                                    <option value="{{ $assessor->id }}" @selected(old('assessor_id', $assessment->assessor_id) == $assessor->id)>
                                        {{ $assessor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('scheduled_date') is-invalid @enderror"
                                ...
                                value="{{ old('scheduled_date', $assessment->scheduled_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="time" class="form-control @error('scheduled_time') is-invalid @enderror"
                                ...
                                value="{{ old('scheduled_time', $assessment->scheduled_time->format('H:i')) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror"
                                ...
                                value="{{ old('duration_minutes', $assessment->duration_minutes) }}" min="15"
                                step="15" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control @error('platform') is-invalid @enderror"
                                id="platform" name="platform" value="{{ old('platform', $assessment->platform) }}">
                            @error('platform')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="url" class="form-control @error('access_link') is-invalid @enderror"
                                id="access_link" name="access_link"
                                value="{{ old('access_link', $assessment->access_link) }}">
                            @error('access_link')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('access_code') is-invalid @enderror"
                                ...
                                value="{{ old('access_code', $assessment->access_code) }}">
                            @error('access_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('expiry_date') is-invalid @enderror"
                                ...
                                value="{{ old('expiry_date', $assessment->expiry_date?->format('Y-m-d')) }}">
                            @error('expiry_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('instructions') is-invalid @enderror" id="instructions" name="instructions"
                                rows="3">{{ old('instructions', $assessment->instructions) }}</textarea>
                            @error('instructions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('questions') is-invalid @enderror" id="questions" name="questions"
                                rows="5" placeholder="Enter questions separated by new lines">{{ old('questions', is_array($assessment->questions) ? implode("\n", $assessment->questions) : '') }}</textarea>
                            @error('questions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('max_score') is-invalid @enderror"
                                id="max_score" name="max_score" value="{{ old('max_score', $assessment->max_score) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('passing_score') is-invalid @enderror"
                                ...
                                value="{{ old('passing_score', $assessment->passing_score) }}" min="1"
                                step="1" required>
                            @error('passing_score')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('skills_evaluated') is-invalid @enderror"
                                id="skills_evaluated" name="skills_evaluated"
                                value="{{ old('skills_evaluated', is_array($assessment->skills_evaluated) ? implode(', ', $assessment->skills_evaluated) : '') }}"
                        ...
                        <div class="col-12">
                                    ...
                                    @foreach ($assessment->attachments as $index => $attachment)
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="{{ route('assessments.download-attachment', ['assessment' => $assessment, 'index' => $index]) }}"
                                                class="me-2">
                                                <i class="ri-file-line"></i> Attachment {{ $index + 1 }}
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <label class="form-label" for="attachments">Add New Attachments</label>
                        ...
                        <div class="col-12 mt-4">
                            <button type="submit" class="btn btn-primary me-2">
                                <i class="ri-save-line"></i> Update Assessment
                            </button>
                    ...
                    .then(candidates => {
                        candidates.forEach(candidate => {
                            const option = new Option(
                                ...
                                false,
                                candidate.id ==
                                {{ old('candidate_id', $assessment->candidate_id) }}
                            );
