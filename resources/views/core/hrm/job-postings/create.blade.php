...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">Create Job Posting</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('position_type') is-invalid @enderror" id="position_type"
                                ...
                                @foreach ($positionTypes as $type)
                                    <option value="{{ $type }}" @selected(old('position_type') == $type)>
                                        {{ ucfirst($type) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('experience_level') is-invalid @enderror"
                                ...
                                @foreach ($experienceLevels as $level)
                                    <option value="{{ $level }}" @selected(old('experience_level') == $level)>
                                        {{ ucfirst($level) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('location_type') is-invalid @enderror" id="location_type"
                                ...
                                @foreach ($locationTypes as $type)
                                    <option value="{{ $type }}" @selected(old('location_type') == $type)>
                                        {{ ucfirst($type) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('salary_min') is-invalid @enderror"
                                id="salary_min" name="salary_min" value="{{ old('salary_min') }}" step="0.01"
                                min="0">
                            @error('salary_min')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('salary_max') is-invalid @enderror"
                                id="salary_max" name="salary_max" value="{{ old('salary_max') }}" step="0.01"
                                min="0">
                            @error('salary_max')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('salary_currency') is-invalid @enderror"
                                id="salary_currency" name="salary_currency" value="{{ old('salary_currency', 'USD') }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('responsibilities') is-invalid @enderror" id="responsibilities"
                                name="responsibilities" rows="5">{{ old('responsibilities') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('qualifications') is-invalid @enderror" id="qualifications"
                                name="qualifications" rows="5">{{ old('qualifications') }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('posting_date') is-invalid @enderror"
                                id="posting_date" name="posting_date" value="{{ old('posting_date', date('Y-m-d')) }}"
                                required>
                            @error('posting_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('internal_notes') is-invalid @enderror" id="internal_notes"
                                name="internal_notes" rows="3">{{ old('internal_notes') }}</textarea>
                        ...
                        <div class="col-12 mt-4">
                            <button type="submit" class="btn btn-primary me-2">
                                <i class="ri-save-line"></i> Save Job Posting
                            </button>
                            <a href="{{ route('job-postings.index') }}" class="btn btn-secondary">
